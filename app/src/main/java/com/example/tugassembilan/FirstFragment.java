...
public class FirstFragment extends Fragment {
    ...
    private static final String YOUTUBE_VIDEO_ID_1 = "avz06PDqDbM";
    private static final String YOUTUBE_VIDEO_ID_2 = "FV3bqvOHRQo";
    private static final String YOUTUBE_VIDEO_ID_3 = "u3V5KDHRQvk";
    private static final String YOUTUBE_VIDEO_ID_4 = "32RAq6JzY-w";
